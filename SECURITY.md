...
- If wanted, set `sandbox: true` under `providers.cursor.settings` yourself; oy preserves upstream's default and does not force it because sandboxing can restrict normal coding workflows.
